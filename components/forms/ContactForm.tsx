  ...
  return (
    <div className="flex h-full w-full items-center justify-center sm:p-6">
      <div className="flex max-w-md flex-col rounded-b-lg border bg-muted/80 shadow-xl md:max-w-none md:flex-row md:rounded-l-lg">
        ...
        <div className="order-1 flex h-[20rem] flex-col items-center justify-center gap-6 rounded-t-lg bg-[url('/images/bg/team-hands-linked-together.jpg')] bg-cover bg-center py-8 text-center  text-white sm:px-14 md:order-2 md:h-auto md:w-[30rem] md:max-w-lg md:rounded-r-lg md:rounded-tl-none lg:min-w-[35rem]">
